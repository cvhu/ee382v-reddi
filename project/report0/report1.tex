...
\vspace{-0.2in}
\end{table}
We compare the performance of V8 engine under different optimization conditions in Table~\ref{table:result2}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{-0.2in}
\begin{table} [hbt!]
\vspace{-0.2in}
\centering
\caption{Performance of V8 Engine with Different Optimization Techniques}
\label{table:result2}
\begin{threeparttable}
\begin{scriptsize}
    \begin{tabular}{|c|c|c|c|c|}
\hline
Benchmarks & Original (s) & No Opt (s) & No IC (s) & No Opt No IC (s)\\
\hline
$25000$th Prime&22.5      &22.0        &95.4       &103.7            \\
\hline
Optimized $25000$th Prime&1.8      &1.8        &85.2       &93.1            \\
\hline
